...
export const TieBreak = { BLACK_LEFT: 'black_left', WHITE_LEFT: 'white_left' };
...
export class DeductiveStrategy extends Strategy {
...
export const BOT_ITEM_ASSIGNMENT = {
  봇1: 'lantern',
  봇2: 'speedRead',
  봇3: 'sickle',
  봇4: 'rope',
...
export class SkilledDeductiveStrategy extends DeductiveStrategy {
...
export class HumanInputStrategy extends Strategy {
  chooseGuess(obs) {
...
export class SkilledHumanInputStrategy extends HumanInputStrategy {
